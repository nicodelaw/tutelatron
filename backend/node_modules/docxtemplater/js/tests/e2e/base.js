...
describe("Retrieving list of templated files", function () {
  it("should return 6 templatedFiles for a simple document", function () {
    ...
    expect(templatedFiles.sort()).to.be.eql(["docProps/app.xml", "docProps/core.xml", "word/document.xml", "word/footer1.xml", "word/header1.xml", "word/settings.xml"]);
  });
});
describe("Api versioning", function () {
  ...
  it("should fail with invalid versions", function () {
    var doc = createDoc("tag-example.docx");
    expectToThrow(doc.verifyApiVersion.bind(null, "5.0"), Errors.XTAPIVersionError, {
    ...
    expectToThrow(doc.verifyApiVersion.bind(null, "3.33.100"), Errors.XTAPIVersionError, {
...
describe("Docxtemplater loops", function () {
  ...
  it("should be possible to have conditions with $index with angular-parser", function () {
    var content = "<w:t>{#todos}{#$index==0}FIRST {/}{text} {/todos}</w:t>";
    var expectedContent = '<w:t xml:space="preserve">FIRST Hello Other todo </w:t>';
    var scope = {
      todos: [{
        text: "Hello"
      }, {
