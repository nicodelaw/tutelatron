...
describe("Module errors", function () {
  ...
  it("should log the error that is returned from render", function () {
    ...
    expect(error.properties.errors[0].properties.file).to.equal("word/document.xml");
    expect(error.properties.errors[0].message).to.equal("foobar last_name");
    expect(error.properties.errors[1].message).to.equal("foobar first_name"); // expect(error.properties.errors[2].message).to.equal("foobar phone");
    ...
    expect(logs[0]).to.satisfy(function (log) {
      return (// for chrome
        log.indexOf(".render") !== -1 || // for firefox
        log.indexOf("render@") !== -1
      );
    });
    var parsedLog = JSON.parse(logs[0]);
    expect(parsedLog.error.length).to.equal(9);
    expect(error.properties.errors[2].properties.file).to.equal("word/header1.xml");
...
describe("Module should pass options to module.parse, module.postparse, module.render, module.postrender", function () {
  it("should pass filePath and contentType options", function () {
    ...
    expect(renderCT).to.equal("application/vnd.openxmlformats-officedocument.extended-properties+xml");
    expect(postparseFP).to.equal("docProps/app.xml");
    expect(postparseCT).to.equal("application/vnd.openxmlformats-officedocument.extended-properties+xml");
    expect(postrenderFP).to.equal("docProps/app.xml");
    expect(postrenderCT).to.equal("application/vnd.openxmlformats-officedocument.extended-properties+xml");
    expect(filePaths).to.deep.equal([// Document appears 2 times because there are 2 tags in the header
    "word/document.xml", "word/document.xml", // Header appears 4 times because there are 4 tags in the header
    ...
    expect(ct).to.deep.equal(["application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml"]);
  });
});
